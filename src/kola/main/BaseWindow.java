...
import kola.event.UiEvent.Type;
...
import kola.utils.DirtyManager;
import kola.utils.HitTester;
...
public class BaseWindow extends BaseComp {
    ...
    private BaseComp createDefaultRoot(int width, int height) {
        ...
        rootComp.setStyleManager(
                ...
                // z-layering. I may add in the future a "forceChildBounds" mode to StyleManager
                // to avoid this kind of special case.
